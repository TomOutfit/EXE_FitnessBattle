...
User createNewcomerUser({
  ...
  return User(
    ...
    calories: 0,
    joinDate: 'Hôm nay',
    ruby: 200, // Quà chào mừng tân thủ: 200 Ruby
    coins: 1500, // Quà tiền vàng ban đầu: 1500 Coins
    stamina: 100,
    maxStamina: 100,
    ...
    badges: [
      ...
      Badge(id: 'b2', name: 'Chuỗi 7 Ngày', icon: 'flame', color: '#f7c948', earned: false),
      Badge(id: 'b3', name: 'Top 50', icon: 'trophy', color: '#ffd700', earned: false),
      Badge(id: 'b4', name: 'Vua Cardio', icon: 'heart-pulse', color: '#ff4757', earned: false),
